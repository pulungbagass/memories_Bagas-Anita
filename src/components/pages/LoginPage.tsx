...
export const LoginPage: React.FC<LoginPageProps> = ({ onLoginSuccess }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      if (password === "bagas ganteng banget") {
        ...
        setError("Incorrect password. Tanya bagas yaa 🤍");
        setIsLoading(false);
      }
    }, 450);
  };
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center p-4 sm:p-6 overflow-hidden bg-[#0c0c1e]">
      ...
      {/* Floating Emojis */}
      <div className="absolute top-[15%] left-[18%] text-2xl opacity-30 select-none pointer-events-none animate-float-slow">
        ✨
      </div>
      <div
        className="absolute bottom-[20%] right-[15%] text-3xl opacity-25 select-none pointer-events-none animate-float-slow"
        ...
        <GlassCard className="p-8 sm:p-10 border-white/10 shadow-2xl shadow-black/50 text-center rounded-3xl">
          ...
          <div className="flex justify-center mb-6">
            <div className="relative p-4 rounded-3xl bg-pink-500/15 border border-pink-500/30 shadow-lg shadow-pink-500/20">
              ...
              <Sparkles
                className="w-4 h-4 text-amber-300 absolute top-2 right-2 animate-spin"
