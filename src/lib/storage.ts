...
export const INITIAL_GALLERY: GalleryItem[] = [
  {
    ...
    description: 'The golden hour was magical, but your smile was the brightest thing on the coast.',
    mediaType: 'photo',
  ...
  },
  {
    ...
    description: 'We talked for 4 hours until the barista gently reminded us it was closing time!',
    mediaType: 'photo',
  ...
  },
  {
    ...
    description: 'We forgot the umbrella in the car, so we decided to dance in the rain instead.',
    mediaType: 'photo',
  ...
  },
  {
    ...
    description: 'Wrapped in two blankets, drinking hot tea, pointing out constellations together under millions of stars.',
    mediaType: 'photo',
...
export const INITIAL_AUDIOS: AudioMemory[] = [
  {
    ...
    description: 'Our eternal relationship anthem. Played in the car every time we watch the sunset.',
  ...
  },
  {
    ...
    type: 'voicenote',
    date: '2024-03-12',
    coverUrl: 'https://images.unsplash.com/photo-1516589178581-6cd7833ae3b2?auto=format&fit=crop&w=400&q=80',
    description: 'Sent when Bagas had an important presentation in the morning.',
...
export const INITIAL_MILESTONES: TimelineMilestone[] = [
  {
    ...
    date: '2022-02-10',
    description: 'Both reaching for the exact same book on the 3rd floor shelf. We smiled and exchanged numbers.',
    emoji: '📚',
  ...
  },
  {
    ...
    date: '2022-03-05',
    description: 'A simple coffee turned into walking through the vintage streets until midnight.',
    emoji: '☕',
    location: 'Bandung',
    category: 'Dates'
  },
  {
    ...
    date: '2022-04-16',
    description: 'Sitting under the gazebo after dinner, Bagas asked Anita to be his partner in life.',
    emoji: '💖',
  ...
  },
  {
    ...
    date: '2023-07-20',
    description: '3 days of exploring Malioboro, culinary adventures, and catching the sunset at Parangtritis.',
    emoji: '✈️',
    location: 'Yogyakarta',
    category: 'Travel'
  },
  {
    ...
    date: '2024-04-16',
    description: 'Celebrating 730 days of growth, patience, laughter, and unbreakable love.',
    emoji: '🥂',
